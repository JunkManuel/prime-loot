import logging      # Create logger to cli
from logging import LogRecord
import traceback
import sys          # Send exit messages

import argparse     # Parse arguments cli
...
# Logger Configuration and initialización
logging.basicConfig(
    level=logging.INFO,
...
if __name__ == "__main__":
    ...
    if arg["debug"]: log.level = logging.DEBUG
